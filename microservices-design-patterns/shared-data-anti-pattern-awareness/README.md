# Shared Data Anti-pattern awareness

## Pattern explanation

Highlight why shared tables between services create hidden coupling and deployment risk.
...
flowchart LR
    ...
    Entry --> Logic[Shared Data Anti-pattern awareness Logic]
