# Service per Container / Serverless Function

## Pattern explanation

Choose a deployment unit per service using containers or functions based on runtime needs.
...
flowchart LR
    ...
    Entry --> Logic[Service per Container / Serverless Function Logic]
